...
parser.add_argument('--entry', default='demo', type=str, help="The entrypoint being run (default='demo')")
...
if parsed_args.entry == 'atsc':
    LabelGroup = None
    REGISTERED_MODEL_NAME = 'ATSCLabelModel'
elif parsed_args.entry == 'values':
    from label.lfs import ValueLabel as LabelGroup
    REGISTERED_MODEL_NAME = 'ValueLabelModel'
elif parsed_args.entry == 'demo':
    LabelGroup = None
else:
    sys.exit("Entry point not recognized")
